...
1. **Tres esquemas de numeración de reglas de negocio en conflicto.** `BUSINESS_ANALYSIS.md` define RN-001 a RN-012; `SOFTWARE_REQUIREMENTS_SPECIFICATION.md` (sección 11) define, de forma independiente, RN-001 a RN-007; `DOMAIN_MODEL.md` define, distribuidas entre varias secciones (Entidades, IA, Inspecciones, Aprendizaje Continuo), RN-001 a RN-049. Los tres esquemas usan los mismos identificadores para reglas distintas. Se requiere una fuente canónica única (`BUSINESS_ANALYSIS.md`, según CLAUDE.md) y renumerar o remapear las reglas de SRS y DOMAIN_MODEL en consecuencia.
